...
const ChooseUs = () => {
    ...
    return (
        <div className=' relative' id='Choose'>
            <Image className=' absolute top-[12%] left-[1%] hidden lg:block' src={'/images/png/trangel.png'} height={95} width={70} alt="trangel" />
            <Image className=' absolute bottom-[8%] right-[1%] lg:block hidden' src={'/images/png/trangel.png'} height={95} width={70} alt="trangel" />
            <div className=' mx-auto max-w-[1140px]'>
                ...
                <Slider {...settings}>
                    <div className='flex justify-center' data-aos="fade-right">
                        <div className=' border-[1px] hov_active rounded-[12px] w-[364px] h-full min-h-[208px] px-[18px] py-[18px] border-[#EEDDFB] '>
                            <Image src={'/images/png/two.png'} width={36} height={36} alt="two" />
                    ...
                    <div className='flex justify-center'>
                        <div className=' border-[1px] hov_active rounded-[12px] w-[364px] h-full min-h-[200px] px-[18px] py-[15px] border-[#EEDDFB] '>
                            <Image src={'/images/png/three.png'} width={36} height={36} alt="two" />
                            <p className=' font-Outfit text-xl font-normal pt-[11px]'>Customer-Centric</p>
                    ...
                    <div className='flex justify-center' data-aos="fade-right">
                        <div className=' border-[1px] hov_active rounded-[12px] w-[364px] h-full min-h-[208px] px-[18px] py-[18px] border-[#EEDDFB] '>
                            <Image src={'/images/png/one.png'} width={36} height={36} alt="one" />
                            <p className=' font-Outfit text-xl font-normal pt-[11px]'>Customer-Centric</p>
                ...
                <Image className=' mt-[55px] lg:pb-16 pb-5' src={'/images/png/tracforming.png'} width={1140} height={527} alt="tracforming" />
            </div>
        </div>
    )
}
